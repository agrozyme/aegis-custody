          ...
          <RowSection style={Row}>
            <div
              ...
              style={{
                ...
                width: '500px',
                margin: '20px',
                backgroundImage: 'url(./images/careers1.jpeg)',
            ...
            <div style={Copy}>
              ...
              <p style={{ margin: '0' }}>
                We are a diverse team of highly-skilled individuals who are
                committed to building amazing products and services. We take our
                work seriously, but at the same time we enjoy what we do.
              </p>
            </div>
          </RowSection>
        </div>
        <div style={Section}>
          <RowSection style={Row}>
            <div style={Copy}>
              ...
              <p style={{ margin: '0' }}>
                We do what is best for our clients. We do what we say we are
                going to do, when we say we are going to do it. We engage in
                direct and candid conversations. We operate as a meritocracy.
              </p>
            </div>
            <div
              className="careerImage"
              style={{
                ...
                width: '500px',
                margin: '20px',
                backgroundImage: 'url(./images/globe.jpeg)',
                backgroundSize: 'cover',
                backgroundPosition: 'center'
              }}
            />
