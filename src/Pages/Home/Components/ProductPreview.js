...
const Content = {
  paragraph1:
    'Aegis Custody provides institutional-grade security through an intuitive combination of cold storage hardware, multisig wallets, and policy-based approvals.'
};
      ...
      <Section keyPage={true}>
        <Desktop>
          ...
          >
            ...
            >
              <p style={{ minWidth: '100%', margin: '0 0 15px 0' }}>
            ...
            <ProductImage className="productImage" style={{ margin: '15px' }}>
              <a href="/product">
                <img
                  className="imagesrc"
                  src="./images/mockuprenders-5.png"
                  alt="product"
                />
              </a>
            </ProductImage>
            ...
            >
              ...
              <div class="secondItem" style={{ minWidth: '100%' }}>
                ...
                />
                <p style={{ margin: '0' }}>
                  Distributed and tiered key management system
                </p>
              </div>
            </div>
          </div>
